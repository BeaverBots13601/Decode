...
class Intake(hardwareMap: HardwareMap, initData: InitData, private val telemetry: Telemetry) : HardwareMechanismKt() {
    override fun start() {
    ...
    companion object : HardwareMechanismSingletonManager<Intake>(::Intake)
}