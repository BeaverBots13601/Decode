...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3517.6552681924545; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 86.4624661092791; // x position of the perpendicular encoder (in tick units)
    }
